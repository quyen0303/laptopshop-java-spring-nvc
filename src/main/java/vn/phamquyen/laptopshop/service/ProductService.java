...
import vn.phamquyen.laptopshop.repository.CartDetailRepository;
import vn.phamquyen.laptopshop.repository.CartRepository;
    ...
    public void handlePlaceOrder(
        ...
        if (cart != null) {
            ...
            if (cartDetails != null) {
                ...
                order.setReceiverName(receiverAddress);
                order.setReceiverName(receiverPhone);
