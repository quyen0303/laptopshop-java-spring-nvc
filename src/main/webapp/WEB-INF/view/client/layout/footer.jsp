                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <p>Address: 928 Le Van Luong, Nha Be</p>
                            <p>Email: paqvippro@gmail.com</p>
                            <p>Phone: +84 3838 70916</p>
                ...
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a href="#"><i
                                    class="fas fa-copyright text-light me-2"></i>PhamQuyen</a>, All
                            right reserved.</span>
                    </div>
